class Organisation < ApplicationRecord
    ...
    def self.linkedin_job_urls
        ...
        orgs.each do |org|
            ...
            url = "https://uk.linkedin.com/jobs/search?keywords=#{param}&location=Edinburgh%2C%20Scotland%2C%20United%20Kingdom&geoId=100209086&trk=public_jobs_jobs-search-bar_search-submit&redirect=false&position=1&pageNum=0"
            job_urls << url
        end
